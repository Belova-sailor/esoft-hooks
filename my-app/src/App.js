  ...
  constructor(props) {
    ...
    this.state = {
      data: [
        ...
        { name: "GIT", src: "./assets/images/git.png", id: 4, skills: 50 },
        ...
        { name: "React", src: "./assets/images/react.png", id: 8, skills: 50 },
        {
        ...
        { name: "NPM", src: "./assets/images/npm.png", id: 12, skills: 50 },
